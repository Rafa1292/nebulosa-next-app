...
interface Props {
  ...
  addPreparationInput: (preparationInput: PreparationInput) => void
...
export const PreparationInputForm = ({
  addPreparationInput,
  preparationInput,
  inputs,
  showForm,
  ...
  useEffect(() => {
    if (preparationInput !== null) {
      ...
      setValue('inputId', preparationInput.inputId)
            ...
            <div className='grid grid-cols-1 gap-4'>
              <div className='flex flex-col'>
                <select
                  ...
                  {...register('inputId', { required: 'El insumo es obligatorio' })}

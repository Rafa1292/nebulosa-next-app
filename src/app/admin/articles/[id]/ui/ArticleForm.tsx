...
import { Article, ArticleModifierGroup, ModifierGroup } from '@/interfaces'
import { useForm } from 'react-hook-form'
import { ErrorMessage } from '@hookform/error-message'
import { useRouter } from 'next/navigation'
import clsx from 'clsx'
import { createUpdateArticle, createUpdateArticleModifierGroup, deleteArticleModifierGroup, getArticleById } from '@/actions'
...
export const ArticleForm = ({ article, modifierGroups }: Props) => {
  ...
  const addArticleModifierGroup = async (articleModifierGroup: ArticleModifierGroup) => {
    const { ok } = await createUpdateArticleModifierGroup(articleModifierGroup, currentArticle.id ?? '')
    if (ok) {
      getArticle()
